...
namespace Model
{
    ...
    public class User
    {
        ...
        public int countlimit { get; set; }     //剩余可借阅数量
    ...
    public class Book
    {
        ...
        public int bookstatus { get; set; }     //馆藏状态：0:在架上；1：被借阅；2：馆内阅读；3：遗失损坏
        ...
        public Book(string number,string namestr,string authorstr,string publisherstr)
        {
            callnumber = number;
            bookname = namestr;
            author = authorstr;
        ...
        public Book(string number, string namestr, string authorstr, string publisherstr,int statusstr)
        {
            callnumber = number;
            bookname = namestr;
            author = authorstr;
        ...
        public Book(string isbnstr, string number, string namestr, string authorstr, string publisherstr, string positionstr)
        {
            isbn = isbnstr;
            callnumber = number;
            bookname = namestr;
        ...
        public Book( string isbnstr,string number, string namestr, string authorstr, string publisherstr,string positionstr,int statusstr)
        {
    ...
    public class Mysql
    {
        ...
        {
            string myconnstr = "Host=192.168.0.254;Database=library;Username='user';Password='123';Charset=utf8";
            //建立连接
        ...
        public bool Getmysqlcom(string sqlstr)
        {
            bool flag;
            //建立连接
